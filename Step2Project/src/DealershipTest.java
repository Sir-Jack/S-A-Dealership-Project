...
public class DealershipTest {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("5. Diplay a Makes details(including cars)");
            System.out.println("6. Diplay the entire Dealership system");
            System.out.println("0. Close System");
            System.out.println("------------------------------");
            
            menuOption = Input.getString("Please enter your menu option (0 - 6)> ");
